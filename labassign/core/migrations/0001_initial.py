# Generated by Django 2.2.5 on 2020-11-03 09:38
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('labGroup', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='core.LabGroup')),
                ('theoryGroup', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='core.TheoryGroup')),
            ],
            options={
                'ordering': ['last_name', 'first_name'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('student1', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='student1_id', to='core.Student')),
                ('student2', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='student2_id', to='core.Student')),
                ('studentBreakRequest', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='core.Student')),
            ],
        ),
        migrations.AddField(
            model_name='labgroup',
