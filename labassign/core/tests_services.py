...
CONVALIDATION_HELP_SERVICE = "convalidation_help"
CONVALIDATION_HELP_TITLE = "Convalidation help"

GROUP_HELP_SERVICE = "group_help"
GROUP_HELP_TITLE = "Group help"

LOGIN_HELP_SERVICE = "login_help"
LOGIN_HELP_TITLE = "Login help"

PAIR_HELP_SERVICE = "pair_help"
PAIR_HELP_TITLE = "Pair help"
...
SERVICE_DEF = {LOGIN_SERVICE: {
    ...
    CONVALIDATION_HELP_SERVICE: {
        "title": CONVALIDATION_HELP_TITLE,
        "pattern": r"You can apply for convalidation if"
    },
    GROUP_HELP_SERVICE: {
        "title": GROUP_HELP_TITLE,
        "pattern": r"You can apply for a laboratory group"
    },
    LOGIN_HELP_SERVICE: {
        "title": LOGIN_HELP_TITLE,
        "pattern": r"To log into the system you need to enter your credentials"
    },
    PAIR_HELP_SERVICE: {
        "title": PAIR_HELP_TITLE,
        "pattern": r"You can apply for a pair"
    },
}
